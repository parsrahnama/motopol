      ...
      <div style={{ maxWidth: 900, margin: '16px auto', display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        {[
          ...
          ...Object.entries(STATUS_MAP).map(([k, v]) => [
            k,
            `${v.label} (${orders.filter((o) => (o.status || 'pending') === k).length})`
          ])
        ].map(([key, label]) => (
          <button
            key={key}
            ...
            style={btn(
              ...
              filterStatus === key ? '#000000' : '#c9d1d9',
              ...
              <div key={order.id} style={{
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...btn('#172554', '#60a5fa', '#2563eb'),
                      opacity: current === 'processing' ? 0.4 : 1
                    }}
                  >
                    ☕ آماده‌سازی
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...btn('#2e1065', '#c084fc', '#7c3aed'),
                      opacity: current === 'out_for_delivery' ? 0.4 : 1
                    }}
                  >
                    🛵 ارسال پیک
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...btn('#3f0d16', '#fb7185', '#e11d48'),
                      opacity: current === 'cancelled' ? 0.4 : 1
                    }}
                  >
                    ❌ لغو
                  </button>
